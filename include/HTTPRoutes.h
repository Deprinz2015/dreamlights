//
// Created by Niklas Koll on 09.10.21.
//

#ifndef MAINCODE_HTTPROUTES_H
#define MAINCODE_HTTPROUTES_H

#define ROUTE_CURRENT_EFFECT "/current"
#define ROUTE_EFFECT "/effect"
#define ROUTE_OFF "/power/off"
#define ROUTE_ON "/power/on"
